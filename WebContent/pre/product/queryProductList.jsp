                ...
                <ul class="cate_list">
                    <c:forEach items="${productList}" var="productList">
                        <li>
                            ...
                            <div class="name"><a href="${ctx}/ProductServlet?action=queryProductDeatil&id=${productList.id}">${productList.name}</a></div>
                            <div class="carbg">
...
function clickimg(id) {
	location.href = contextPath+"/ProductServlet?action=queryProductDeatil&id="+id+"&userId=${sessionScope.easybuyUserLogin.id}";
}
</script>
</body>
</html>
